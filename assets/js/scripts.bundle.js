...
$(function () {
    Analytics = {
        init: function () {
            ...
            var s = document.getElementById("user").getContext("2d");
            new Chart(s, {
                type: "line",
                data: {
            ...
            if (0 === $("#song").length) return !1;
            var s = document.getElementById("song").getContext("2d");
            new Chart(s, {
                type: "bar",
                data: {
                    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
                ...
                options: {
                    ...
                    scales: {
                        ...
                        xAxes: [{display: !1, barPercentage: .5}]
                    },
                    layout: {padding: 0, margin: 0}
                }
            })
            ...
            var s = document.getElementById("purchase").getContext("2d");
            new Chart(s, {
                type: "line",
                data: {
                    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
            ...
            var s = document.getElementById("userStatistics").getContext("2d");
            new Chart(s, {
                type: "bar",
                data: {
                    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
...
$(function () {
    AudioPlayer = {
        init: function () {
                ...
                songs: [{
                    ...
                    special: {
                        songs: [{
                            ...
                            artist: "Arebica Luna",
                            album: "Mummy",
                            url: "zedlists/assets/audio/ringtone-1.mp3",
                            cover_art_url: "assets/images/cover/small/1.jpg"
                        }, {
            ...
            s.on("change", function () {
                var s = $(this), e = parseInt(s.val(), 10);
            ...
            $("a[data-audio]").on("click", function () {
                ...
                Amplitude.removeSong(0), Amplitude.playNow(s)
            })
        }
